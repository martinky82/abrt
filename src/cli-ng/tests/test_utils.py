...
class UtilsTestCase(clitests.TestCase):
    ...
    def test_fmt_problems_empty_input(self):
        ...
        self.assertEquals(fmt_problems(None), '')
    ...
    def test_query_yes_no(self):
        ...
        import __builtin__
        with clitests.monkey_patch(__builtin__, 'raw_input', mock_raw_input):
            with captured_output() as (cap_stdout, cap_stderr):
                res = query_yes_no('question')
            ...
            with captured_output() as (cap_stdout, cap_stderr):
                res = query_yes_no('question', default=None)
            ...
            with captured_output() as (cap_stdout, cap_stderr):
                res = query_yes_no('question', default='no')
